class MouseCursor {
    constructor() {
        this.page = document.querySelector('#et-boc');
    ...
    updateOnHover(e) {
        ...
        if (tagName === 'LABEL' ||
            ...
            // (e.target.parentElement.tagName === 'A' && e.target.tagName === 'SVG') ||
            // (e.target.parentElement.tagName === 'A' && e.target.tagName === 'span')
        ) {
    ...
    activateMagnetic() {
        this.links.map(link => {
            ...
            link.addEventListener('mousemove', function (e) {
                that.moveTarget(e, this, this.querySelector('span'), 25);
